...
public class FxStartTrading {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            fxTransaction.trade(new Instruction("SSY", InstructionType.BUY, Currency.SAR,
            ...
            fxTransaction.trade(new Instruction("DPA", InstructionType.BUY, Currency.HKD,
                    LocalDate.now().minusWeeks(1), LocalDate.now().minusWeeks(1).with(TemporalAdjusters.next(DayOfWeek.FRIDAY)),
                    BigDecimal.valueOf(0.73), BigDecimal.valueOf(1.07), 500));
            ...
            fxTransaction.trade(new Instruction("SSY", InstructionType.SELL, Currency.SAR,
                                     LocalDate.now().minusWeeks(1), LocalDate.now().minusWeeks(1).with(TemporalAdjusters.next(DayOfWeek.FRIDAY)),
            ...
            fxTransaction.trade(new Instruction("DPA", InstructionType.SELL, Currency.SGD,
                                        LocalDate.now().minusWeeks(1), LocalDate.now().minusWeeks(1).with(TemporalAdjusters.next(DayOfWeek.TUESDAY)),
                    BigDecimal.valueOf(0.72), BigDecimal.valueOf(0.97), 200));
            fxTransaction.trade(new Instruction("DPA", InstructionType.SELL, Currency.HKD,
                                        LocalDate.now().minusWeeks(1), LocalDate.now().minusWeeks(1).with(TemporalAdjusters.next(DayOfWeek.SUNDAY)),
